                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-5">
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                ...
                                <div class="card-body">
                                    <div class="small mb-3 text-muted">이메일 주소를 입력하면 암호를 재설정할 수 있는 링크가 전송됩니다.</div>
                                    <form>
                                        ...
                                        <div class="d-flex align-items-center justify-content-between mt-4 mb-0">
                                            <a class="small" href="./login.php">로그인하러 가기</a>
                                            <a class="btn btn-primary" href="login.html">확인</a>
                                        </div>
                                    </form>
                                </div>
                                <div class="card-footer text-center py-3">
                                    <div class="small"><a href="register.php">계정이 없으신가요?</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
